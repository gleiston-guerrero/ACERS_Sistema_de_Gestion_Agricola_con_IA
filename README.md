...
La versión vigente para evaluación es la etiqueta anotada **`v2.6-cierre`**, publicada sobre la rama `main`. Las etiquetas `v2.0-final`, `v2.3-final`, `v2.4-suspenso`, `v2.4-cierre` y `v2.5-cierre` se mantienen en el historial como referencia histórica, pero no deben usarse para la evaluación.
