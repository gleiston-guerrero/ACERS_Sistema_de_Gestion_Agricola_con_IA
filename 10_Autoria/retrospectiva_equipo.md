...
- El 17 de septiembre por la mañana actualizó `CITATION.cff` a la versión 2.5.0, agregó la línea correspondiente en el CHANGELOG, regeneró el manifiesto raíz dos veces (desde clon limpio la segunda vez), y creó la etiqueta anotada de cierre `v2.5-cierre` (12:07).
